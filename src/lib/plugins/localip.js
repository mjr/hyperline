...
// Credits: https://github.com/naotone/hyperline/blob/master/src/lib/plugins/localip.js
...
function getLocalIp() {
  ...
  for (const i in interfaces) {
    ...
    interfaces[i].some((el) => {
      if(!el.internal && el.family === 'IPv4'){
        localip = el.address;
        return true;
      }
    });
...
export default class LocalIp extends Component {
  static displayName() {
    return 'localip'
  }
